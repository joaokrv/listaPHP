<!-- 
    ...
    Proposta: Desenvolver uma página que receba o preço atual de um produto e a porcentagem de reajuste desejada.
    A partir desses dados, o sistema deve calcular e exibir o novo preço do produto com o reajuste aplicado.

    A entrada dos dados é feita por meio de um formulário retroalimentado (método GET) e a porcentagem de reajuste
    é ajustável por um controle deslizante (input range), com valor exibido em tempo real via JavaScript.
-->
